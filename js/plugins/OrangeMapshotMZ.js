...
(function ($) {
    ...
    $.Param = {};
    $.Param.useMapName = $.Parameters.useMapName !== "true";
    $.Param.drawAutoShadows = $.Parameters.drawAutoShadows !== "true";
    ...
    $.Param.imageQuality = Number($.Parameters.imageQuality || 100);
    ...
    $.saveMapshot = function () {
        ...
        try {
                ...
                try {
                    ...
                    var callback = function (error) {
                        if (error !== undefined && error !== null) {
                            console.error('An error occured while saving the mapshot 1:', error);
                        }
                    };
                    ...
                    if (error !== undefined && error !== null) {
                        console.error('An error occured while saving the map shot 2:', error);
                    }
                }
            });
            ...
            if (error !== undefined && error !== null) {
                console.error('An error occured while saving the mapshot 3:', error);
            }
        }
    };
